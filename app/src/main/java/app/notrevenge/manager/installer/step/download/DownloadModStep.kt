package app.notrevenge.manager.installer.step.download

import androidx.compose.runtime.Stable
import app.notrevenge.manager.R
import app.notrevenge.manager.installer.step.download.base.DownloadStep
import java.io.File
...
class DownloadModStep(
    ...
    override val downloadFullUrl: String = "https://github.com/Purple-EyeZ/not-revenge-xposed/releases/latest/download/app-release.apk"
