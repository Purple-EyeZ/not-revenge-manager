...
android {
    namespace = "app.notrevenge.manager"
    compileSdk = 34

    defaultConfig {
        applicationId = "app.notrevenge.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"Revenge Next\"")
        buildConfigField("String", "MANAGER_NAME", "\"NotRevengeManager\"")
        buildConfigField("String", "REPO", "\"revenge-mod/revenge-bundle-next\"")
        ...
        buildConfigField("String", "MODDED_APP_PACKAGE_NAME", "\"app.revenge.next\"")
        buildConfigField("int", "MODDED_APP_ICON", "0xFE6914B3")
